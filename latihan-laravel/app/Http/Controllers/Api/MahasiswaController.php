...
class MahasiswaController extends Controller
{
    public function index(Request $request)
    {
        ...
        // --- Penanganan parameter `fields` ---
        if ($request->filled('fields')) {
            $kolomValid = [
                'id', 'nim', 'nama', 'email',
                'angkatan', 'ipk', 'aktif', 'program_studi',
            ];
            ...
            $request->attributes->set('fields', $fields);
        }
    ...
    public function byProgramStudi(Request $request, ProgramStudi $programStudi)
{
